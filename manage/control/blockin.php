...
if ($MSG == ""){
	...
	if (! $rs->eof){
		...
		$data_array['strLink'] = SqlFilter($_POST['strLink'],"tab")."',";
		$data_array['Contents'] = SqlFilter($_POST['Contents'],"tab")."',";
		$data_array['isShow1'] = SqlFilter($_POST['isShow1'],"int")."',";
		$data_array['isShow2'] = SqlFilter($_POST['isShow2'],"int")."',";
		for ($i = 1; $i <= $total_uploads; $i++) {
