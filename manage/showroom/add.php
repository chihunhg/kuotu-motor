...
//序號+1
$sql = "Select Sort from showroom Where Module_PKey= :Module_PKey Order By Sort desc limit 1";
                ...
                <tr>
                  ...
                  <td>
                    <div class="upload-box">
                      <div class="photo">
                        <img id="preview2">
                        <span id="Photo2_txt" class="red"></span>
                      </div>
                      <div class="file-upload">
                        <label for="Photo2">
                          <input name="Photo2" type="file" accept="image/jpeg,image/gif,image/png" id="Photo2" size="30" onChange="checkFile('Photo2',1000,'img')" />
                          選擇檔案</label>
                      </div>
                    </div>
                    <ul class="set-tips">
