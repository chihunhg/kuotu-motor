...
<body <?php echo $bodytxt; ?> class="topPage">
    ...
    <section class="wrapper">
        <div class="container">
            <div class="pay-bk">
                <div class="pay_step">
                <div class="container"><img src="images/hotaipay/05/invitation_card4.png?20221207" width="100%"></div>
                </div>
                <div class="goto-box goto-box-two3 clearfix">
                    <a href="https://www.kuotu-motor.com.tw/lexus/repair.htm" class="goto-btn" title="立即預約" target="_blank" rel="noopener noreferrer">立即預約<i class="bi bi-arrow-right-circle"></i></a>
