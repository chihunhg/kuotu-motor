            <div class="sidebar">
                ...
                <div id="sidenav" class="collapse in">
                    ...
                    <?php if ($pageName == "p1") { ?>
                        ...
                        <li <?php if ($subPageName == "p1_3") { ?> class="active"<?php } ?>><a href="https://www.facebook.com/LexusKuotuMotor" target="_blank" rel="noopener noreferrer" title="<?php echo $p1_3;?>"><?php echo $p1_3;?></a></li>
