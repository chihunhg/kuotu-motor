            <div class="sidebar">
                ...
                <div id="sidenav" class="collapse in">
                    <ul class="nav navbar">
                    <?php if ($pageName == "p1") { ?>
                        <li <?php if ($subPageName == "p1_1") { ?> class="active"<?php } ?>><a href="news.php" title="<?php echo $p1_1;?>"><?php echo $p1_1;?></a></li>
                        <li <?php if ($subPageName == "p1_2") { ?> class="active"<?php } ?>><a href="discount.php" title="<?php echo $p1_2;?>"><?php echo $p1_2;?></a></li>
                        <li <?php if ($subPageName == "p1_3") { ?> class="active"<?php } ?>><a href="https://www.facebook.com/ToyotaKuotuMotor" target="_blank" rel="noopener noreferrer" title="<?php echo $p1_3;?>"><?php echo $p1_3;?></a></li>
                        <li <?php if ($subPageName == "p1_4") { ?> class="active"<?php } ?>><a href="contact.php" title="<?php echo $p1_4;?>"><?php echo $p1_4;?></a></li>
                        
                    <?php } else if ($pageName == "p2") { ?>
                        <li<?php if ($subPageName == "p2_1") { ?> class="active"<?php } ?>><a href="p2_news.php" title="<?php echo $p2_1;?>"><?php echo $p2_1;?></a></li>
                        <li<?php if ($subPageName == "p2_2") { ?> class="active"<?php } ?>><a href="p2_news_2.php" title="<?php echo $p2_2;?>"><?php echo $p2_2;?></a></li>
