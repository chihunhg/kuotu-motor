...
<body <?php echo $bodytxt; ?> class="topPage">
    ...
    <section class="wrapper">
        <div class="container">
            <div class="pay-bk">
                <div class="pay_step">
                <div class="container"><img src="images/hotaipay/05/invitation_card2.png?20230328" width="100%"></div>
                </div>
                <div class="goto-box goto-box-two3 clearfix">
                    <a href="https://ob.ctbcbank.com/card/#/apply?CrdTp&Crd=C_HOTAI&Act=L00&Fa=Y&Unit=75000&Emp=22814&SPC=57110&Seed=QUE5MzI2NA==" class="goto-btn" title="立即辦卡" target="_blank" rel="noopener noreferrer">立即辦卡<i class="bi bi-arrow-right-circle"></i></a>
